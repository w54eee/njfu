...
x0 = (chushi(1):0.1:chushi(2))';
y0 = (chushi(3):0.1:chushi(4))';
z0 = 30;
...
%                          plot3(sec(1),sec(2),sec(3),'.','Markersize',10,'color','b');
            total_sec =[total_sec;sec,(i+1)/2,sqrt((AA(i+1,1)-sec(1))^2+(AA(i+1,2)-sec(2))^2+(AA(i+1,3)-sec(3))^2),j];
        end
    end
end
